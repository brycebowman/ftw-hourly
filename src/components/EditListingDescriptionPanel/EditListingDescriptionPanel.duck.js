...
export const CLEAR_UPDATED_FORM = 'app/EditListingDescriptionPanel/CLEAR_UPDATED_FORM';

export const UPLOAD_IMAGE_REQUEST = 'app/EditListingDescriptionPanel/UPLOAD_IMAGE_REQUEST';
export const UPLOAD_IMAGE_SUCCESS = 'app/EditListingDescriptionPanel/UPLOAD_IMAGE_SUCCESS';
export const UPLOAD_IMAGE_ERROR = 'app/EditListingDescriptionPanel/UPLOAD_IMAGE_ERROR';

export const UPDATE_PROFILE_REQUEST = 'app/EditListingDescriptionPanel/UPDATE_PROFILE_REQUEST';
export const UPDATE_PROFILE_SUCCESS = 'app/EditListingDescriptionPanel/UPDATE_PROFILE_SUCCESS';
export const UPDATE_PROFILE_ERROR = 'app/EditListingDescriptionPanel/UPDATE_PROFILE_ERROR';
