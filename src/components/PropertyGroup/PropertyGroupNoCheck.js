...
const IconCheck = props => {
  ...
  return (
    <svg width="0" height="0" xmlns="http://www.w3.org/2000/svg" className={classes}>
      <path
...
const PropertyGroupNoCheck = props => {
...
PropertyGroupNoCheck.defaultProps = {
  rootClassName: null,
  className: null,
  selectedOptions: [],
  twoColumns: false,
...
PropertyGroupNoCheck.propTypes = {
...
export default PropertyGroupNoCheck;
