...
import IconHourGlass from './IconHourGlassNoicon';
...
*/
class LocationAutocompleteInputImplNoicon extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const inputClass = classNames(inputClassName || css.inputnoicon, { [validClassName]: isValid });
...
LocationAutocompleteInputImplNoicon.defaultProps = {
  autoFocus: false,
  closeOnBlur: true,
  rootClassName: null,
  className: null,
...
LocationAutocompleteInputImplNoicon.propTypes = {
  autoFocus: bool,
  rootClassName: string,
  className: string,
  closeOnBlur: bool,
