...
import css from './FieldTextInputOval.module.css';

const CONTENT_MAX_LENGTH = 5000;

class FieldTextInputOvalComponent extends Component {
  render() {
...
FieldTextInputOvalComponent.defaultProps = {
  rootClassName: null,
  className: null,
  inputRootClass: null,
  onUnmount: null,
...
FieldTextInputOvalComponent.propTypes = {
...
class FieldTextInputOval extends Component {
  ...
  render() {
    return <Field component={FieldTextInputOvalComponent} {...this.props} />;
  }
}

export default FieldTextInputOval;
