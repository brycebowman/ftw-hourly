...
import css from './Refunds.module.css';
...
const Refunds = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
      REFUNDS Café Temps is growing into a trusted marketplace where restaurant managers and workers connect in a manner that is mutually beneficial. Restaurant managers gain access to a broad talent pool that helps them keep their businesses open when they are short-staffed. Workers are compensated fairly for providing help on short notice.
      </p><p>
      For the marketplace to function, we rely on workers and managers to act in a manner that enables transparency and healthy communication. For this reason, we created Community Refunds that we actively enforce. We take violations of these Community Refunds seriously and may suspend or terminate an Account for ongoing or serious violations. We reserve the right to also edit or remove content on our site that violates these Community Refunds or if we believe it adversely affects the integrity of the Café Temps marketplace.
      </p>
      <p>By using the Café Temps platform, you agree to our Community Refunds. If you have any questions about these Community Refunds or if you believe that a user has violated these Community Refunds, please email us immediately at admin@cafetemps.com.
      </p>
      <h2>FOR WORKERS</h2>
