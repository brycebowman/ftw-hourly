...
import FieldDateInputOval from './FieldDateInputOval';
    ...
    render={fieldRenderProps => {
      ...
      return (
        ...
        >
          ...
          <FieldDateInputOval {...dateInputProps} />
...
export const Empty = {
  ...
  props: {
    ...
    dateInputProps: {
      ...
      onBlur: () => console.log('onBlur called from DateInputOval props.'),
      onFocus: () => console.log('onFocus called from DateInputOval props.'),
    },
    onChange: formState => {
