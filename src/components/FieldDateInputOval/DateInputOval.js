...
import css from './DateInputOval.module.css';
...
class DateInputOvalComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      focused: false,
  ...
  render() {
    ...
    const placeholder = placeholderText || intl.formatMessage({ id: 'FieldDateInputOval.placeholder' });

    const screenReaderInputText =
      screenReaderInputMessage ||
      intl.formatMessage({ id: 'FieldDateInputOval.screenReaderInputMessage' });

    const closeDatePickerText = phrases.closeDatePicker
      ? phrases.closeDatePicker
      : intl.formatMessage({ id: 'FieldDateInputOval.closeDatePicker' });

    const clearDateText = phrases.clearDate
      ? phrases.clearDate
      : intl.formatMessage({ id: 'FieldDateInputOval.clearDate' });
...
DateInputOvalComponent.defaultProps = {
  className: null,
  useMobileMargins: false,
  ...defaultProps,
};

DateInputOvalComponent.propTypes = {
  className: string,
  id: string,
  focused: bool,
...
export default injectIntl(DateInputOvalComponent);
