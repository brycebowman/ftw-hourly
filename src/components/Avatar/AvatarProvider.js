...
export const AvatarProviderComponent = props => {
  const {
    rootClassName,
    className,
    initialsClassName,
...
AvatarProviderComponent.defaultProps = {
  className: null,
  rootClassName: null,
...
AvatarProviderComponent.propTypes = {
...
const AvatarProvider = injectIntl(AvatarProviderComponent);

export default AvatarProvider;

export const AvatarProviderMedium = props => (
  <Avatar rootClassName={css.mediumAvatar} renderSizes={AVATAR_SIZES_MEDIUM} {...props} />
);
AvatarProviderMedium.displayName = 'AvatarProviderMedium';

export const AvatarProviderLarge = props => (
  <AvatarProvider rootClassName={css.largeAvatar} renderSizes={AVATAR_SIZES_LARGE} {...props} />
);
AvatarProviderLarge.displayName = 'AvatarProviderLarge';
