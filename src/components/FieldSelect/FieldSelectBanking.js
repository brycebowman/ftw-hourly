...
import css from './FieldSelectBanking.module.css';
...
const FieldSelectBankingComponent = props => {
  const {
    rootClassName,
    className,
    selectClassName,
...
FieldSelectBankingComponent.defaultProps = {
  rootClassName: null,
  className: null,
...
FieldSelectBankingComponent.propTypes = {
...
const FieldSelectBanking = props => {
  return <Field component={FieldSelectBankingComponent} {...props} />;
};

export default FieldSelectBanking;
